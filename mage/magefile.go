...
var (
	...
	getGolangciLint = magelib.GetGolangciLint()
	getGoreleaser   = magelib.GetGoreleaser()
	getGotagger     = magelib.GetGotagger()
	getGotestsum    = magelib.GetGotestsum()
	getStentor      = magelib.GetStentor()
)
